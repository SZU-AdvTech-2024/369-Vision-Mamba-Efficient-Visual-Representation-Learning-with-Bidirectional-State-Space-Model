...
class Mamba(nn.Module):
    def __init__(
        ...
        # dt_rank是离散化的步长总数，原文里每16个单位一个步长（向上取整），也可自定义
        ...
        # self.d_state * 2 属于 B/C参数，self.dt_rank属于delta参数的原始维度
    ...
    def forward(self, hidden_states, masks=None, inference_params=None):
        """
        hidden_states: (B, L, D)
